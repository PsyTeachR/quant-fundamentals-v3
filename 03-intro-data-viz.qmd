...
### Activity 6 - Covert to factors {#introviz-a2}
...
1. Which of these is the appropriate order of functions to create a barplot? 

`r longmcq(sample(c(answer = "ggplot() + geom_bar()", "ggplot() %>% geom_bar()", "geom_bar() + ggplot()", "geom_plot() + geom_boxplot()")))`

2. Why would this line of code not create a barplot, assuming you already loaded all data and libraries and you spelt the data and column names correctly?
...
3. If I wanted precisely 5 bars in my histogram, what argument would I use? 
